...
import com.dnc.buendeal.core.base.navigation.NavigationCommand
...
import com.dnc.buendeal.core.utils.loge
import com.dnc.buendeal.network.NetworkState
...
abstract class BaseViewModel : ViewModel(), KoinScopeComponent {
    ...
    protected fun sendError(throwable: Throwable) {
        launch(dispatcher = mainContext) {
            defaultErrorLiveData.setNewValue(exceptionParser.parseError(throwable))
        }
    }
